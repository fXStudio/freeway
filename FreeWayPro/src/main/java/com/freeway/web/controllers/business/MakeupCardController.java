...
public class MakeupCardController {
	private @Autowired IMakeupCardService makeupCardService;
	 ...
	 * @return
	 */
	@RequestMapping(value = "makeupCardList")
	public Object loseCardList(ConditionFiled cf, HttpServletRequest request) {
		...
		map.put("totalCount", makeupCardService.getSize(cf));// 记录总数
		map.put("items", makeupCardService.findRecords(cf));// 记录行对象
