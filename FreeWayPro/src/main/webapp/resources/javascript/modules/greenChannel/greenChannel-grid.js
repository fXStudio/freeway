...
Ext.onReady(function() {
			...
			var store = new Ext.data.JsonStore({
				...
				url : '../services/greenChannelList', // 数据服务
				fields : [ { // 数据集字段
					name : 'deptName'
				}, { // 数据集字段
					name : 'passTimes'
								...
								new Ext.ux.form.SearchField(
										{
											...
											onTrigger1Click : function() {
												if (this.hasSearch) {
													...
													this.store.baseParams["deptName"] = '';
													this.store.reload({
														params : o
													});
											...
											onTrigger2Click : function() {
												...
												this.store.baseParams["deptName"] = Ext.getCmp('dept').getValue();
												this.store.reload({
													params : o
												});
												this.hasSearch = true;
						            ...
						            listeners: {
						            	click: function(){
						            		...
						            		window.location.href = "../services/greenChannelExport?deptName=" + dept + "&beginDate=" + beginDate + "&endDate=" + endDate;
						            	}
						            }
						        }],
