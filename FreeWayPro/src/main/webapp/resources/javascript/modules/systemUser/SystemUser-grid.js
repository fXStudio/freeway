...
Ext.onReady(function() {
    ...
    var store = new Ext.data.JsonStore({
        ...
        url: 'services/systemUserList', // 数据服务
        fields: [{ // 数据集字段
            name: 'username'
        }, {
            name: 'password'
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        height: parent.window.document.body.clientHeight,
        width: 300,
        height: 300,
        ...
        tbar: new Ext.Toolbar({
            items: [{
                text: '添加',
                handler: addSystemUser,
                iconCls: 'add'
            }, {
                text: '修改',
                handler: updateSystemUser,
                iconCls: 'update'
            }, '-', {
                text: '删除',
                ...
                xtype: 'label',
                html: '<span style="margin:5px 6px;font-size:9pt;color:gray;">系统用户维护</span>'
            }]
        }),
